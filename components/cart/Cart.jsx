                      ...
                      <div className="flex flex-wrap lg:flex-row gap-5  mb-4">
                        ...
                        <div className="w-24">
                          <div className="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1">
                            ...
                            <input
                              type="number"
                              className="outline-none focus:outline-none text-center w-[50px] bg-gray-300 font-semibold text-md hover:text-black  pl-0 focus:text-black  md:text-base cursor-default flex items-center text-gray-900 custom-input-number"
                              name="custom-input-number"
                              value={cartItem.quantity || ''}
                              onChange={(event) => {
                                const newQty = parseInt(event.target.value);
                                if (newQty > 0 && newQty <= Number(cartItem.stock)) {
                                  const item = { ...cartItem, quantity: newQty };
                                  addItemToCart(item);
                                } else if (newQty === 0) {
